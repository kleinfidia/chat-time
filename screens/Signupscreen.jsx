...
const Signupscreen = () => {
  ...
  return (
    <View className =" flex-1 items-center justify-start">
        <Image source={BGimage} resizeMode='cover' className=" h-72 " style={{width: screenwidth}}/>
        <>
          {/* list avatars */}
          <View className=" absolute inset-0 z-10 w-full" style={{width: screenwidth, height: screenHeight}}>
              <ScrollView>
                <BlurView className=" w-full h-full px-4 py-16 flex-row flex-wrap items-center justify-evenly" tint='light' intensity={60} style={{width: screenwidth, height: screenHeight}}>
     ...
     <View className=" w-full h-full bg-white rounded-tl-[90px] -mt-32 flex items-center justify-start py-6 px-6 space-y-4">
          ...
          <Text className=" py-2 text-primaryText font-semibold text-xl"> join  us!</Text>
          {/* Avatar */}
        ...
        <View className=" w-full flex items-center justify-center">
          {/* full name*/}
          <UserinputText placeHolder ="Full Name" isPass={false} setStatValue={setname} />
          {/* email */} 
